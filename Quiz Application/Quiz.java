...
public class Quiz extends JFrame implements ActionListener
{
	...
	Quiz(String name)
	{
        ...
        questions[1][0] = "In java arrays are ..?";
        questions[1][1] = "Object";
        questions[1][2] = "Object reference";
        questions[1][3] = "Primitive datatype";
        ...
        questions[4][0] = "What is the extension of java code file ?";
        questions[4][1] = ".Js";
        questions[4][2] = ".text";
        questions[4][3] = ".class";
        questions[4][4] = ".java";
        ...
        questions[9][0] = "In java byte,short,int and long all these are..?";
        questions[9][1] = "Signed";
        questions[9][2] = "Unsigned";
        questions[9][3] = "All of the above";
        ...
        back.setBounds(1100,700,200,40);
